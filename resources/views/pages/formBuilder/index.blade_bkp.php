                        ...
                        <table class="table border table-striped table-bordered text-nowrap tb-form">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $f->status }}</td>
                                    <td style="width: 12px">
                                        <a href="javascript:void(0)" class="btn btn-info setting-form" data-bs-toggle="modal" data-bs-target="#myModal" data-form-id="{{ $f->id }}">
                                            <i class="fas fa-cog"></i>
                                        </a>
                                        <a href="{{ route('formBuilder.preview') }}?form={{ $f->id }}" class="btn btn-success">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        {{-- @if ($f->status == 'draft') --}}
                                        <a href="{{ route('formBuilder.add') }}?form={{ $f->id }}" class="btn btn-warning">
                                            <i class="fas fa-pencil-alt"></i>
                                        </a>
                                        {{-- @endif --}}
                                        <a href="javascript:void(0)" class="btn btn-danger" id="del-form" data-html="{{ $f->id }}">
            ...
            <form action="" id="conditional-form">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-3">
                                <input class="form-control" type="text" id="logic" name="logic" placeholder="Division Name" value="if" readonly>
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-3">
                                <input class="form-control" type="text" id="name" name="condition" value="must pass" readonly>
                            </div>
                            <div class="col-md-9">
